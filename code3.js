...
gdjs.EndScreenCode.asyncCallback15251172 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback15251172(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xd2a700 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xd2a700(runtimeScene);
