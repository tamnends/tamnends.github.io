...
gdjs.EndScreenCode.asyncCallback15432220 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback15432220(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0x1074e80 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0x1074e80(runtimeScene);
